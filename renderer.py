...
from models.tensoRF import TensorVM, TensorCP, raw2alpha, TensorVMSplitNoMat, TensorVMSplitCube, TensorVMSplit, AlphaGridMask
from utils import *
...
@torch.no_grad()
def render_ml(test_dataset,tensorf, renderer, savePath=None, N_vis=5, prtx='', N_samples=-1,
               white_bg=True, ndc_ray=False, device='cuda'):
    rgb_maps, depth_maps = [], []
